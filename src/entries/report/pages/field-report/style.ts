...
import modalBackgroundPng from '../../assets/field-report-detail-background.png';

export const fieldReportStyle = createStyles(({ css }) => {
  return {
    row: css`
      width: 100%;
      height: 100%;
...
export const modalStyle = createStyles(({ css }) => {
  return {
    modalContent: css`
      background: url(${modalBackgroundPng}) no-repeat center center;
    `,
    modalHeader: css`
